...
export const registered = require("../assets/icons/edit.png");
export const finished = require("../assets/icons/verify.png");
export const rejected = require("../assets/icons/reject.png");
