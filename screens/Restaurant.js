        ...
        return (
            <View>
                ...
                >
                    ...
                    >
                        <Text style={{ ...FONTS.h3 }}>{getBasketItemCount()} productos en el Carrito</Text>
                        <Text style={{ ...FONTS.h3 }}>S/.{sumOrder()}</Text>
                    </View>
                    <View
                        style={{
                            flexDirection: 'row',
                    ...
                    >
                        <View style={{flexDirection: 'row'}}>
                            ...
                            />
                            <Text style={{ marginLeft: SIZES.padding, ...FONTS.h4 }}>Ubicación</Text>
                        </View>
                        <View style={{ flexDirection: 'row' }}>
                            <Image
